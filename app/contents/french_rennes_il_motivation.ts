...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université de Rennes</h2>
    ...
    <section>
        ...
        <p class="text-sm font-semibold text-gray-800">Candidature en Master 1 Ingénierie Logicielle</p>
    </section>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            ...
            je vous adresse ma candidature pour intégrer le Master 1 Ingénierie Logicielle à l'ISTIC
            à la rentrée 2026.
        ...
        <p>
            C'est dans cette continuité que le parcours Ingénierie Logicielle de l'ISTIC s'impose
            pour moi comme une étape déterminante. La réputation de l'ISTIC en ingénierie logicielle,
            la rigueur de son approche orientée conception et architecture logicielle, ainsi que la vitalité
            de l'écosystème tech rennais, l'un des premiers pôles numériques de France, font de votre formation
            un cadre idéal pour approfondir mes compétences. Les enseignements du parcours IL, couvrant aussi bien
            la modélisation et la vérification de logiciels que les méthodes de développement avancées, répondent
            précisément aux axes que je souhaite approfondir après ma licence, et correspondent à la direction
            que je veux donner à ma carrière en concevant des systèmes logiciels robustes et maintenables.
        </p>

        <p>
            Convaincu que votre Master me permettra de consolider mes compétences en conception et architecture
            logicielle, mais aussi de poursuivre mes projets personnels avec une expertise renforcée,
