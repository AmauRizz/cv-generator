...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université d'Angers</h2>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            C'est dans cette continuité que le Master Informatique de l'Université d'Angers représente
            pour moi une étape déterminante. Son organisation en tronc commun de M1 ouvrant sur des parcours
            de M2 spécialisés correspond précisément à ma démarche de consolider mes fondamentaux en conception
            de systèmes avant de m'orienter, selon les opportunités de l'année, vers le génie logiciel ou
            l'ingénierie des systèmes d'information. La possibilité de suivre le cursus en alternance constitue
            par ailleurs un atout que je souhaite pleinement explorer, afin de développer une expérience
            professionnelle concrète en parallèle de ma formation.
        </p>
 
        <p>
             Convaincu que votre Master me permettra de consolider mes compétences 
             en développement d'applications et de poursuivre mes projets personnels avec une expertise renforcée, 
