...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université du Littoral Côte d'Opale</h2>
    ...
    <section>
        ...
        <p class="text-sm font-semibold text-gray-800">Candidature en Master 1 Ingénierie du Logiciel Libre (I2L)</p>
    </section>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            ...
            je vous adresse ma candidature pour intégrer le Master 1 Ingénierie du Logiciel Libre (I2L)
            à la rentrée 2026.
        ...
        <p>
            C'est dans cette continuité que le Master Ingénierie du Logiciel Libre de l'Université du Littoral
            Côte d'Opale s'impose pour moi comme une étape déterminante. La philosophie du logiciel libre,
            transparence du code, collaboration ouverte et partage des connaissances, est une valeur que j'ai
            intégrée naturellement dans ma pratique. Mes projets personnels reposent sur des outils open source
            et j'ai à coeur de rendre mes réalisations accessibles. Votre formation, en structurant cette démarche
            autour d'un enseignement rigoureux du génie logiciel, me permettrait de franchir un cap décisif en
            contribuant à des projets libres de grande envergure avec la méthode et l'expertise d'un ingénieur
            pleinement formé à ces enjeux.
        </p>
        
        <p>
            Convaincu que votre Master me permettra de consolider mes compétences en conception et développement
            de logiciels libres, mais aussi de poursuivre mes projets personnels avec une expertise renforcée, 
