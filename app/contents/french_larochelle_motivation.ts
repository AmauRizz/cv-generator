...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Lettre de motivation - La Rochelle Université</h2>
    ...
    <section>
        ...
        <p class="text-sm font-semibold text-gray-800">Candidature en Master 1 Informatique - parcours Architecte Logiciel</p>
    </section>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            ...
            je vous adresse ma candidature pour intégrer le Master 1 Architecte Logiciel à la rentrée 2026.
        ...
        <p>
            C'est dans cette continuité que le Master Architecte Logiciel de La Rochelle Université représente
            pour moi une étape déterminante. En tant qu'étudiant de votre université depuis trois ans, j'ai pu mesurer
            la qualité de l'encadrement et la rigueur des enseignements. Le parcours Architecte Logiciel, par son orientation
            professionnalisante et sa possibilité d'alternance, correspond précisément à mon projet d'acquérir une expertise
            en conception de systèmes logiciels tout en développant une première expérience significative en entreprise.
            Ayant établi ma vie à La Rochelle depuis plusieurs années, je bénéficie d'un cadre stable
            et familier qui me permettra de poursuivre cette formation dans les meilleures conditions, notamment pour
            la recherche d'une entreprise dans le cadre d'une alternance.
        </p>
 
        <p>
            Convaincu que votre Master me permettra de consolider mes compétences en conception logicielle et de continuer
            à m'épanouir dans l'écosystème rochelais, je suis disponible pour tout entretien ou complément d'information.
        </p>
