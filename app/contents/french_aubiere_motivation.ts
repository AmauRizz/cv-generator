...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université Clermont Auvergne</h2>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            C'est dans cette continuité que le Master informatique de l'Université Clermont Auvergne s'impose
            pour moi comme une étape déterminante. La structure du cursus, avec un tronc commun en M1 donnant accès
            à plusieurs parcours de M2, correspond précisément à ma démarche de consolider mes compétences en
            conception de systèmes avant de me spécialiser, notamment vers le développement logiciel ou web,
            en fonction des domaines qui auront retenu mon attention au cours de l'année. L'ISIMA, par sa réputation
            dans la formation d'ingénieurs logiciels et son ancrage dans l'écosystème numérique régional, représente
            un cadre que j'estime particulièrement adapté à ce projet.
        </p>
 
        <p>
            Convaincu que votre Master me permettra de consolider mes compétences 
             en conception logicielle et de poursuivre mes projets personnels avec une expertise renforcée, 
