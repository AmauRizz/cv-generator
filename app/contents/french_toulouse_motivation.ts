...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université de Toulouse</h2>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            ...
            je vous adresse ma candidature pour intégrer le Master 1 Sciences du Logiciel à la rentrée 2026.
        ...
        <p>
            C'est dans cette continuité que le Master Sciences du Logiciel de l'Université Toulouse 3 Paul Sabatier
            s'impose pour moi comme une étape déterminante. La renommée de votre département en génie logiciel,
            la rigueur de son programme autour de la conception, de la vérification et de la qualité du logiciel,
            ainsi que l'ancrage de Toulouse dans un tissu industriel exceptionnel, Airbus, Thales
            ou encore de nombreuses start-ups deeptech, font de votre formation un cadre idéal pour approfondir
            mes compétences en ingénierie logicielle. L'accent mis sur les méthodes formelles, les architectures
            logicielles et le développement de logiciels fiables correspond précisément à la direction que je
            souhaite donner à mon parcours.
        </p>

        <p>
            Convaincu que votre Master me permettra de consolider mes compétences en conception et développement
            de logiciels robustes, mais aussi de poursuivre mes projets personnels avec une expertise renforcée,
