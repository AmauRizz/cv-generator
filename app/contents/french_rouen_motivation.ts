...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université de Rouen Normandie</h2>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            ...
            je vous adresse ma candidature pour intégrer le Master 1 Informatique de l'Université de Rouen Normandie
            à la rentrée 2026.
        ...
        <p>
            C'est dans cette continuité que le Master Informatique de l'Université de Rouen Normandie s'impose
            pour moi comme une étape déterminante. La richesse des parcours proposés en M2, qu'il s'agisse
            de génie logiciel, de systèmes distribués ou de sécurité informatique, offre une progression
            structurée qui correspond à mon souhait de consolider mes fondamentaux avant de me spécialiser.
            La réputation de l'UFR Sciences et Techniques de Rouen, son ancrage dans l'écosystème industriel
            normand et sa proximité avec des acteurs majeurs de la région me convainquent que votre formation
            est un cadre stimulant pour franchir cette étape. Le stage de remise à niveau en début de cursus
            témoigne également d'un encadrement pédagogique sérieux, auquel j'attache une grande importance.
        </p>

        <p>
            Convaincu que votre Master me permettra de consolider mes compétences en conception logicielle
            et en architecture de systèmes, tout en me donnant les outils pour poursuivre mes projets personnels
            avec une expertise renforcée, je suis disponible pour tout entretien ou complément d'information.
        </p>
