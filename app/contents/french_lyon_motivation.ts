...
<div class="flex flex-col gap-5">
    <section class="flex justify-between items-start">
        <div>
            ...
            <h2 class="text-base text-blue-600 font-semibold mt-1">Candidature - Université Claude Bernard Lyon 1</h2>
    ...
    <section class="text-base flex flex-col gap-4 text-gray-700 leading-relaxed flex-1">
        ...
        <p>
            C'est dans cette continuité que le Master informatique de l'université Claude Bernard représente
            pour moi une étape déterminante. La diversité des parcours de M2 proposés, notamment en développement
            logiciel web et conception de réseaux informatiques, correspond à la trajectoire que je souhaite construire,
            en consolidant mes compétences en conception de systèmes en M1, puis me spécialiser en fonction des opportunités
            et des domaines qui auront retenu mon attention au cours de l'année. Lyon, par son dynamisme économique
            et la densité de ses entreprises numériques, offre par ailleurs un environnement propice à la recherche de stage
            ou d'alternance dans ces secteurs.
        </p>
 
        <p>
            Convaincu que votre Master me permettra de consolider mes compétences 
            pour la conception de service lié au web mais aussi de poursuivre mes projets personnels avec une expertise renforcée, 
